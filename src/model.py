...
class ProtacModel(nn.Module):
    def __init__(self,
        ...
        #print("self.protac_model",self.protac_model)
        self.ligase_pocket_model = ligase_pocket_model
        #print("self.ligase_pocket_model",self.ligase_pocket_model)
        self.target_pocket_model = target_pocket_model
        #print("self.target_pocket_model",self.target_pocket_model)
    ...
    def forward(self,
        ...
        # #print("protac",fea_protac)
        # #print("protac_model start")
        v_0 = self.protac_model(protac_graphs, fea_protac)
        # #print("protac_model stop")
        # #print("ligase_pocket_model start")
        v_1 = self.ligase_pocket_model(ligase_pocket, fea_e3)
        # #print("ligase_pocket_model stop")
        # #print("target_pocket_model start")
        v_3 = self.target_pocket_model(target_pocket, fea_tar)
        # #print("target_pocket_model stop")
        # #print("v_f start")
